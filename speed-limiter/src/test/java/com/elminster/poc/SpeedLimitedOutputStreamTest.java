...
public class SpeedLimitedOutputStreamTest {

    private static final Logger logger = LoggerFactory.getLogger(SpeedLimitedOutputStreamTest.class);

    //private static final long FILE_SIZE = 10 * 1024 * 1024 + 25; // 10 MB
    //private static final int SPEED_LIMITION = 500 * 1024; // 500 KB/s
    ...
    @Test
    public void testSpeedLimitedOutputStream() throws IOException {
    ...
    private void fileCopyWithSpeedLimiter(File src, File dest, SpeedLimiter speedLimiter) throws IOException {
        try (FileInputStream fis = new FileInputStream(src);
                ...
                SpeedLimitedOutputStream speedLimitedOut = new SpeedLimitedOutputStream(fout, speedLimiter)) {
            copyStream(fis, speedLimitedOut);
        }
    }
